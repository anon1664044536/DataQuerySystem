...
public class NatSQLEvaluator {
    ...
    public static void main(String[] args) {
        ...
        String predictionsFile = "spider/predictions-natsql.txt";
        String metricsFile = "spider/metrics_log-natsql.txt";

        if (DataManager.apiKey().isBlank() || DataManager.mqlNatSQLAppId().isBlank() || DataManager.sqlNatSQLAppId().isBlank()) {
            System.err.println("Error: DashScope API key or NatSQL App ID is missing.");
            return;
        }

        AskingAgent agent = new AskingAgent(DataManager.apiKey(), DataManager.mqlNatSQLAppId(), DataManager.sqlNatSQLAppId());
